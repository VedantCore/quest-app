...
CREATE TABLE public.notifications (
  ...
  CONSTRAINT notifications_manager_id_fkey FOREIGN KEY (manager_id) REFERENCES public.users(user_id),
  ...
  CONSTRAINT notifications_step_id_fkey FOREIGN KEY (step_id) REFERENCES public.task_steps(step_id),
  CONSTRAINT notifications_submission_id_fkey FOREIGN KEY (submission_id) REFERENCES public.step_submissions(submission_id)
);
