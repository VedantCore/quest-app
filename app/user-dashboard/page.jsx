  ...
  return (
    <div className="min-h-screen bg-[#faf8eb] font-sans text-[#171717]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-lg text-gray-600">
                {activeTab === 'profile' ? 'Manage your account settings' : 'Track your progress and manage your tasks'}
              </p>
            </div>
          </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-[#171717]">{stats.activeTasks}</p>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-[#171717]">{stats.completedTasks}</p>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-[#171717]">{stats.totalPoints}</p>
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-[#171717]">{stats.overallProgress || 0}%</p>
                  </div>
        ...
        <div className="mt-6">
          {activeTab === 'tasks' && <TaskList userId={user.uid} onStatsUpdate={setStats} mode="enrolled" />}
          {activeTab === 'profile' && <Profile userId={user.uid} onStatsUpdate={setStats} />}
        </div>
      </div>
    </div>
  );
