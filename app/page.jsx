...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#faf8eb] relative font-sans text-[#171717]">
      {/* Grid Background */}
      <div className="absolute inset-0 bg-grid-pattern opacity-[0.6] pointer-events-none z-0" />

      <div className="relative z-10">
        <div className="bg-[#faf8eb]/80 backdrop-blur-md sticky top-0 z-50 border-b border-black/5">
          <Navbar
        ...
        <section className="px-6 py-16 md:py-36 max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold tracking-tight text-[#171717] mb-6 sm:mb-8 leading-[1.1] sm:leading-[1.1]">
            ...
            <span className="text-blue-600 block md:inline"> build better together.</span>
          </h1>
          
          <p className="mt-4 sm:mt-6 text-lg sm:text-xl text-gray-600 max-w-2xl sm:max-w-3xl mx-auto leading-relaxed font-medium">
        ...
        <section id="features" className="px-6 py-16 sm:py-24 scroll-mt-20">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-20">
              ...
              <p className="mt-3 text-lg text-gray-600">Powerful features for modern teams</p>
            </div>
            ...
            <div className="grid gap-6 sm:gap-8 grid-cols-1 md:grid-cols-3">
              {[
                ...
                <div key={i} className="group p-6 sm:p-8 bg-white border border-gray-200/60 rounded-2xl shadow-sm hover:shadow-xl hover:border-gray-300 transition-all duration-300">
                  <div className={`w-12 h-12 sm:w-14 sm:h-14 ${feature.bg} ${feature.color} rounded-xl flex items-center justify-center mb-5 sm:mb-6 group-hover:scale-110 transition-transform`}>
                    <svg className="w-6 h-6 sm:w-7 sm:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      {feature.icon}
                    </svg>
                  </div>
                  <h3 className="text-xl sm:text-2xl font-bold text-[#171717] mb-2 sm:mb-3">{feature.title}</h3>
        ...
        <section id="pricing" className="px-6 py-16 sm:py-24 scroll-mt-20">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="mt-3 text-lg text-gray-600">Start for free, scale as you grow</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { name: 'Starter', price: '$0', desc: 'For individuals and small teams.', features: ['Up to 10 Users', 'Unlimited Quests', 'Basic Analytics', 'Community Support'] },
                { name: 'Pro', price: '$12', desc: 'For growing teams that need more.', features: ['Unlimited Users', 'Advanced Analytics', 'Private Projects', 'Priority Support'], popular: true },
                { name: 'Enterprise', price: 'Custom', desc: 'For large organizations.', features: ['SSO & Advanced Security', 'Dedicated Success Manager', 'Custom Contracts', 'SLA Support'] }
              ].map((plan, i) => (
                <div key={i} className={`relative p-8 bg-white rounded-2xl border ${plan.popular ? 'border-blue-600 shadow-xl' : 'border-gray-200 shadow-sm'} hover:shadow-lg transition-shadow`}>
                  {plan.popular && (
                    <div className="absolute top-0 right-0 bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-bl-xl rounded-tr-xl">
                      POPULAR
                    </div>
                  )}
                  <h3 className="text-xl font-bold text-[#171717]">{plan.name}</h3>
                  <div className="mt-4 mb-2 flex items-baseline gap-1">
                    <span className="text-4xl font-extrabold text-[#171717]">{plan.price}</span>
                    {plan.price !== 'Custom' && <span className="text-gray-500">/user/mo</span>}
                  </div>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="flex-1 space-y-6">
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  We believe project management shouldn't feel like a chore. Quest was born from the frustration of complex, bloated tools that slow teams down.
                </p>
                <p className="text-gray-600 leading-relaxed text-lg">
                  Our mission is to empower teams to focus on what matters most: <span className="font-semibold text-[#171717]">building great software</span>. We combine simplicity with power to create a tool that gets out of your way.
                </p>
            ...
            <div className="bg-white border border-gray-200 rounded-[2rem] p-8 sm:p-16 relative overflow-hidden text-center shadow-xl">
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                <h2 className="text-3xl sm:text-5xl font-bold text-[#171717] mb-6 tracking-tight leading-tight">
                  Ready to transform how <br className="hidden sm:block" /> you build software?
                </h2>
                <p className="text-gray-600 text-lg sm:text-xl mb-10 leading-relaxed font-medium">
                  Join a community of high-performing teams who are shipping faster and staying aligned with Quest.
                </p>
        ...
        <footer className="border-t border-black/5 pt-16 pb-12 mt-12 bg-transparent">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
              <div className="col-span-2 lg:col-span-2">
                <Link href="/" className="text-2xl font-bold tracking-tight text-[#171717] flex items-center gap-2 mb-6">
                  <div className="h-8 w-8 rounded bg-[#171717]"></div>
                  Quest
                </Link>
                <p className="text-gray-500 text-sm leading-relaxed max-w-xs mb-6">
                  The modern standard for project management. Built for speed, designed for clarity, and loved by developers.
                </p>
                <div className="flex space-x-4">
                  <span className="h-8 w-8 rounded-full bg-white/50 border border-gray-200 hover:bg-white hover:border-gray-300 flex items-center justify-center cursor-pointer transition-all text-gray-600">
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  <li><Link href="#" className="hover:text-blue-600 transition-colors">Start a Quest</Link></li>
                  <li><Link href="#" className="hover:text-blue-600 transition-colors">Templates</Link></li>
                  <li><Link href="#" className="hover:text-blue-600 transition-colors">Integration Gallery</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-3 text-sm text-gray-600">
                  ...
                  <li><Link href="#" className="hover:text-blue-600 transition-colors">Community Forum</Link></li>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center text-xs text-gray-400 font-medium pt-8 border-t border-black/5">
              ...
              <div className="flex gap-6 mt-4 sm:mt-0">
                ...
                <Link href="#" className="hover:text-[#171717] transition-colors">Terms of Service</Link>
              </div>
            </div>
          </div>
        </footer>
