...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full flex">
      {/* Left Side - Brand & Info (Japanese Content) */}
      <div className="hidden md:flex md:w-1/2 bg-indigo-900 text-white flex-col justify-center px-12 lg:px-24 relative overflow-hidden">
